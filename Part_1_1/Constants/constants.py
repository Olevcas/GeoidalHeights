...
#df_EGM2008 = pd.read_fwf('Part_1_1/Data/EGM_2008.txt', colspecs=colspecs_EGM2008, skiprows=19, nrows=501499)
df_EGM2008 = pd.read_fwf('Part_1_1/Data/EGM_2008.txt', colspecs=colspecs_EGM2008, skiprows=19)
